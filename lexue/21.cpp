...
int main()
{
	...
	if(month>12){printf("month is error.");return 0;}
	for(i=q;i<year;i++)
	{
	...
	int run0=0;
	    ...
	    if(month==1)
	    {
	    	if(day>31){printf("day is error.");return 0;}
	    	days+=day;
		}
		if(month==2)
		{
			if(day>28+run0){printf("day is error.");return 0;}
	    	days+=31+day;
		}
		if(month==3)
		{
		...
		if(month==4)
		{
			if(day>30){printf("day is error.");return 0;}
			days+=run0;
			days+=31+28+31;
			days+=day;
		}
